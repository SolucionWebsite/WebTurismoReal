    ...
    public class BodyCorreo
    {
        public string Body(string nombre)
        {
            string mensaje = "Hola," + " " + nombre + "<br/>" +
                ...
                "¿Ya registraste a tus acompañantes?, si es así, súper! y si no, es de suma importancia que registre los datos de sus acompañantes, esto lo puede hacer en la sección \"Mi cuenta\" -> \"Acompañantes\", este proceso lo puede hacer hasta 24 horas antes del ingreso al departamento." + "<br/>" + "<br/>" +
                ...
                "Con respecto a Servicios Extra, ahora que ya tienes tu reserva, puedes dirigirte a nuestra página web" + " " + "<a href=\"http://localhost:57174/Index\" > Turismoreal.cl</a>" + " " +

                    ...
                    <div class="card" style="margin-top:5px; padding:15px;">
                        <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td><asp:Button ID="Btn_Clave" CssClass="btn-active" Text="Cambiar contraseña" runat="server" OnClick="Btn_Clave_Click"/></td>
                            </tr>
                            <tr>
                    ...
                    <div class="card" style="margin-top:5px; padding:15px;">
                        ...
                        <div>
                            ...
                            <div>
                               ...
                               <div> <asp:TextBox ID="Txt_Clave_Actual" placeholder="Ingresa tu contraseña actual"  Text="" TextMode="Password" CssClass="form-control"  runat="server" />
                               </div>
                               </fieldset>
                            ...
                            <div>
                               ...
                               <div> <asp:TextBox ID="Txt_Clave_Nueva" placeholder="Ingresa tu contraseña nueva"  Text="" TextMode="Password"  CssClass="form-control"  runat="server" />
                               </div>
                               </fieldset>

...
<body>
    <form id="form1" runat="server">
        <video class="bg-video" autoplay="autoplay" muted="muted" loop="loop" poster="assets/img/bg.jpg">
                                ...
                                <tr>
                                    <td>
                                        <fieldset>
                                            ...
                                            <div>
                                                <asp:DropDownList class="form-control" AutoPostBack="true" ID="Cmb_Region" runat="server" ToolTip="Seleccionar región de destino" OnSelectedIndexChanged="Cmb_Region_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </fieldset>
                                ...
                                <tr>
                                    <td>
                                        <fieldset>
                                            ...
                                            <div>
                                                <asp:DropDownList class="form-control" AutoPostBack="true" ID="Cmb_Comuna" runat="server" ToolTip="Seleccionar región" OnSelectedIndexChanged="Cmb_Comuna_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </fieldset>

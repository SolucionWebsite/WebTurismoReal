    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                ...
                <asp:Panel ID="PanelProgreso" runat="server">
                            ...
                            <tr>
                                <td>
                                    <fieldset>
                                        ...
                                        <div>
                                            <asp:TextBox runat="server" placeholder="Ingresa tu correo" legend="Correo" class="form-control" type="email" ID="txt_usuario" />
                                        </div>
                                    </fieldset>
